...
#ny_avtale()
tittel = 'avtaletittel2'
sted = "norge"
starttidspunkt = datetime.now()
varighet = 10
kategorgi = "test"
#print (Avtale(tittel,sted, starttidspunkt, varighet, kategorgi))
dict_liste[tittel]=Avtale(tittel,sted, starttidspunkt, varighet, kategorgi)
tittel = "avtaletittel"
sted = "norge"
starttidspunkt = datetime.now()
varighet = 10
...
#skriv_ut_dict(dict_liste)
skrivtilfil()
skrivtildict()

skriv_ut_dict(dict_liste)
#print (dict_liste.items())